...
{
    public class KillFactionGroupShipConditionListener : QuestConditionListener, IBattleInstanceListener
    {
        ...
        public KillFactionGroupShipConditionListener(QuestListener quest, JsonNode info) : base(quest, info)
        {
        }
        ...
        protected override void LoadConditionInfo(JsonNode doc)
        {
            ...
            Faction = (Faction?)(byte?)doc["group_faction"] ?? Faction.None;
        ...
        void IBattleInstanceListener.OnMobDestroyed(int fleetId, MobKillInfo mobInfo)
        {
            ...
            if (mobInfo.FactionGroup == FactionGroup &&
